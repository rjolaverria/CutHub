      ...
      <form className='form' onSubmit={(e) => onSubmit(e)}>
        <div className='form-group'>
          <select name='status' value={status} onChange={(e) => onChange(e)}>
            ...
            <option value='Apprentice Barber'>Apprentice Barber</option>
            <option value='Master Barber'>Master Barber</option>
            <option value='Hair Stylist'>Hair Stylist</option>
            <option value='Hair Designer'>Hair Designer</option>
            <option value='Hair Care Specialist'>Hair Care Specialist</option>
            <option value='Colorist'>Colorist</option>
            <option value='Master Braider'>Hair Stylist</option>
            <option value='Instructor'>Instructor or Teacher</option>
            <option value='Salon Owner'>Intern</option>
        ...
        <div className='form-group'>
          ...
          />
          <small className='form-text'>
            Please use comma separated values (eg. Fades,Shaves,Braids)
          </small>
        </div>
        <div className='form-group'>
          <textarea
